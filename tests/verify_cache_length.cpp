...
namespace {
	...
	void verify_negative_k(F1&& on_each, F2&& on_max)
	{
	...
	template <class Float, class F1, class F2>
	void verify_positive_k(F1&& on_each, F2&& on_max)
	{
		using namespace jkj::dragonbox::detail;
	...
	template <class Float, class F1, class F2>
	void verify_negative_k_nearest_shorter_interval(F1&& on_each, F2&& on_max)
	{
		using namespace jkj::dragonbox::detail;
	...
	template <class Float, class F1, class F2>
	void verify_positive_k_nearest_shorter_interval(F1&& on_each, F2&& on_max)
	{
		using namespace jkj::dragonbox::detail;
	...
	template <class Float, class F1, class F2>
	void verify_negative_k_right_closed_directed_shorter_interval(F1&& on_each, F2&& on_max)
	{
		using namespace jkj::dragonbox::detail;
	...
	template <class Float, class F1, class F2>
	void verify_positive_k_right_closed_directed_shorter_interval(F1&& on_each, F2&& on_max)
	{
		using namespace jkj::dragonbox::detail;
...
void verify_cache_length()
{
	...
	std::cout << "\nVerifying IEEE-754 binary32 format for negative k...\n";	

	out.open("test_results/binary32_negative_k.csv");
	out << "e,required_bits\n";
	verify_negative_k<float>(on_each, on_max);
	out.close();

	out.open("test_results/binary32_negative_k_nearest_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_negative_k_nearest_shorter_interval<float>(on_each, on_max);
	out.close();

	out.open("test_results/binary32_negative_k_right_closed_directed_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_negative_k_right_closed_directed_shorter_interval<float>(on_each, on_max);
	out.close();


	std::cout << "\nVerifying IEEE-754 binary32 format for positive k...\n";

	out.open("test_results/binary32_positive_k.csv");
	out << "e,required_bits\n";
	verify_positive_k<float>(on_each, on_max);
	out.close();

	out.open("test_results/binary32_positive_k_nearest_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_positive_k_nearest_shorter_interval<float>(on_each, on_max);
	out.close();

	out.open("test_results/binary32_positive_k_right_closed_directed_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_positive_k_right_closed_directed_shorter_interval<float>(on_each, on_max);
	out.close();


	std::cout << "\nVerifying IEEE-754 binary64 format for negative k...\n";

	out.open("test_results/binary64_negative_k.csv");
	out << "e,required_bits\n";
	verify_negative_k<double>(on_each, on_max);
	out.close();

	out.open("test_results/binary64_negative_k_nearest_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_negative_k_nearest_shorter_interval<double>(on_each, on_max);
	out.close();

	out.open("test_results/binary64_negative_k_right_closed_directed_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_negative_k_right_closed_directed_shorter_interval<double>(on_each, on_max);
	out.close();


	std::cout << "\nVerifying IEEE-754 binary64 format for positive k...\n";

	out.open("test_results/binary64_positive_k.csv");
	out << "e,required_bits\n";
	verify_positive_k<double>(on_each, on_max);
	out.close();

	out.open("test_results/binary64_positive_k_nearest_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_positive_k_nearest_shorter_interval<double>(on_each, on_max);
	out.close();

	out.open("test_results/binary64_positive_k_right_closed_directed_shorter_interval.csv");
	out << "e,required_bits\n";
	verify_positive_k_right_closed_directed_shorter_interval<double>(on_each, on_max);
	out.close();
