...
The core idea of Schubfach, which Dragonbox is based on, is a continuous analogue of discrete [pigeonhole principle](https://en.wikipedia.org/wiki/Pigeonhole_principle). German name of this principle is *Schubfachprinzip* (meaning "drawer principle"), thus the name *Schubfach*. Since the pigeonhole principle is sometimes also called *Dirichlet's box principle*, the name *Dragonbox* is honoring its origins: Schubfach (box) and Grisu (dragon).
